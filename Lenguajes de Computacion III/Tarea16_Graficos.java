...
public class Tarea16_Graficos extends JFrame {
     ...
     * @param title
     */
    public Tarea16_Graficos(String title) {
        super(title);
        chartPanel = new JPanel(new BorderLayout());
        add(chartPanel, BorderLayout.CENTER);

        // Botón para cambiar el gráfico manualmente
        ...
        // Temporizador para cambiar los gráficos automáticamente cada 3 segundos
        //timer = new Timer(3000, e -> changeChart());
        //timer.start();
    ...
    private ChartPanel createChartPanel1() {
        ...
        JFreeChart chart = createPieChart(dataset, "¿Qué sistema operativo usas?");
    ...
    // Métodos para crear los datasets correspondientes a cada gráfico
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Tarea16_Graficos example = new Tarea16_Graficos("Ejemplo de Gráficos Dinámicos");
