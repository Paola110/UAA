...
import org.jfree.chart.ChartFactory; // Importar ChartFactory
import org.jfree.chart.ChartPanel; // Importar ChartPanel
import org.jfree.chart.JFreeChart; // Importar JFreeChart
import org.jfree.chart.plot.CategoryPlot; 
import org.jfree.data.category.DefaultCategoryDataset;

public class Tarea17_P2Numeros extends JFrame {

    private JPanel panel;

    public Tarea17_P2Numeros() {
        setSize(800, 600);
    ...
    public static void main(String[] args) {
        Tarea17_P2Numeros ventana = new Tarea17_P2Numeros();
